...
def simulate_hpc_cluster():
    ...
    print(
        "Downloading 250MB Production Model Weights..."
    )
    ...
    print(
        "[Junior Dev] "
        "'Oops, I opened the production model in Write mode!'"
    )

    try:
        model = open(weight_file, "w")
        model.write(
            "Initializing random weights... Overwriting!"
        )
        model.close()
        ...
        print(
            ">>> The multi-million dollar model is safe."
        )
